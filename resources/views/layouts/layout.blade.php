...
<body>
    ...
    <div class="page-wrapper">
        <div class="content">
            {{-- This is the main content area. You can replace this with your actual content. --}}
            @yield('content')
        </div>
        ...
        <div class="footer">
            <div class="footer-main">
                <div class="footer-top">
                    ...
                    <p class="footer-desc">One of Libyas' most prominent learning management systems. encompassing a wide range of educational opportunities.</p>
